...
@section('conteudo')
<h1>Agregar Estudante em Disciplina</h1>
...
<form method="post" action="{{ route('estudantes.subscrever') }}">
    ...
    <div class="row">
        <div class="mb-3">
            <label for="disciplina" class="form-label">Estudante</label>
            <input type="text" disabled value="{{ $estudante->nome }}" class="form-control">
        </div>
        <div class="mb-3">
